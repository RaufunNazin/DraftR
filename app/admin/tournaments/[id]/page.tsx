      ...
      <div className="container mx-auto py-8 px-4">
        <div className="flex items-center mb-8">
          ...
          <div>
            ...
            <div className="flex items-center gap-2 mt-1">
              <span className="text-sm text-muted-foreground">Tournament Code:</span>
              <div className="bg-secondary/30 rounded-md px-2 py-1 flex items-center">
                <span className="font-mono font-bold tracking-wider mr-2">{tournament.code}</span>
                <Button variant="ghost" size="icon" className="h-6 w-6" onClick={copyTournamentCode}>
        ...
        <Tabs defaultValue="players" className="w-full">
          ...
          <TabsContent value="players">
            <PlayerRegistration tournamentId={tournament.id} onPlayersUpdated={loadTournament} />
          </TabsContent>

          <TabsContent value="captains">
            <CaptainManagement tournamentId={tournament.id} onCaptainsUpdated={loadTournament} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
